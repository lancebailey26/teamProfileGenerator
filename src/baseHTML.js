...
function cardTitle(employee){
    ...
    switch (role){
        case "Manager":
            returner = `bg-danger text-white text-center`;
            break;
        case "Engineer":
            returner = `bg-warning text-white text-center`
            break;
        case "Intern":
            returner = `bg-info text-white text-center`
            break;
    }
    return returner;
}
...
function cardIcon(employee){
    ...
    switch (role){
        case "Manager":
            returner = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-briefcase" viewBox="0 0 16 16">
            <path d="M6.5 1A1.5 1.5 0 0 0 5 2.5V3H1.5A1.5 1.5 0 0 0 0 4.5v8A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-8A1.5 1.5 0 0 0 14.5 3H11v-.5A1.5 1.5 0 0 0 9.5 1h-3zm0 1h3a.5.5 0 0 1 .5.5V3H6v-.5a.5.5 0 0 1 .5-.5zm1.886 6.914L15 7.151V12.5a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5V7.15l6.614 1.764a1.5 1.5 0 0 0 .772 0zM1.5 4h13a.5.5 0 0 1 .5.5v1.616L8.129 7.948a.5.5 0 0 1-.258 0L1 6.116V4.5a.5.5 0 0 1 .5-.5z"/>
          </svg>`;
            break;
        case "Engineer":
            returner = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-keyboard" viewBox="0 0 16 16">
            ...
            break;
        case "Intern":
            returner = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-vector-pen" viewBox="0 0 16 16">
...
function cardCreator(employee){
    ...
    <div class = "card-header ${cardTitle(employee)}">${employee.getName()} - ${cardIcon(employee)}</div>
    <div class="card-body">
      <h6 class="card-subtitle mb-2 font-weight-bold">${employee.getRole()}</h6>
